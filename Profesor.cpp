...
void Profesor::setNombreProfesor(string nombreProfesor) {
	Usuario::setNombre(nombreProfesor);
}

void Profesor::setApellidoProfesor(string apellidoProfesor) {
	Usuario::setApellido(apellidoProfesor);
}

void Profesor::setEmailProfesor(string emailProfesor) {
	Usuario::setEmail(emailProfesor);
}
...
string Profesor::getApellidoProfesor() {
	return Usuario::getApellido();
}

string Profesor::getEmailProfesor() {
...
bool Profesor::getDisponibilidadProfesor(int dia, int slot) {
	return Profesor::disponibilidad.getDisponibilidad(dia,  slot);
}
